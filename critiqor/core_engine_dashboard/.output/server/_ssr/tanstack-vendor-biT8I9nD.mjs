...
import { s as resolveManifestAssetLink, j as rootRouteId, v as defineHandlerCallback, w as getNormalizedURL, x as getOrigin, y as attachRouterServerSsrUtils, z as createSerializationAdapter, A as createRawStreamRPCPlugin, i as invariant, g as isNotFound, l as isRedirect, C as isResolvedRedirect, D as mergeHeaders, E as executeRewriteInput, F as defaultSerovalPlugins, G as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-IhsfkX9Y.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ByJJYtQN.mjs").then((n) => n.r),
    import("./start-C35qKuLH.mjs"),
